...
def make_pipeline():
    ...
    quarterly_sales = FFundamentals.sales_qf.latest
    
    intang = FFundamentals.intang.latest
    ...
    mean_close_10_winsorized = mean_close_10.winsorize(min_percentile=0.05, max_percentile=0.95)
    quarterly_sales_winsorized = quarterly_sales.winsorize(min_percentile=0.05, max_percentile=0.95)
    intang_winsorized = intang.winsorize(min_percentile=0.05, max_percentile=0.95)
    ...
    combined_factor = (
        ...
        mean_close_10_winsorized.zscore() +
        quarterly_sales_winsorized.zscore() +
        intang_winsorized.zscore()
    )
